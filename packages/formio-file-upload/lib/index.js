 ...
 */
const FileComponent$1 = js.Components.components.file;
    ...
    uploadFile(file) {
        return new Promise((resolve, reject) => {
            const uploadFile = {
                ...
                type: file.type,
                storage: 'tus',
                status: exports.UploadStatus.PENDING,
                createdAt: new Date(),
                updatedAt: new Date()
            };
            const upload = new Upload(file, {
                ...
                onError: (error) => {
                    ...
                    uploadFile.status = exports.UploadStatus.FAILED;
                    uploadFile.error = {
                        code: 'UPLOAD_ERROR',
                ...
                onProgress: (bytesUploaded, bytesTotal) => {
                    ...
                    uploadFile.status = exports.UploadStatus.UPLOADING;
...
const FileComponent = js.Components.components.file;
    ...
    setupUppyEventHandlers() {
        ...
        this.uppy.on('upload-success', (file, response) => {
            ...
            const uploadFile = {
                ...
                status: exports.UploadStatus.COMPLETED,
                createdAt: new Date(),
                updatedAt: new Date()
            };
