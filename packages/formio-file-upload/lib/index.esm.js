...
const WHITELABEL_CONFIG = {
     ...
     */
    ID_PATTERNS: {
        UPLOAD_CONTAINER: (key) => `${key}-upload-widget`,
        REACT_ROOT: (key) => `${key}-root`,
    }};
...
class MultiImageUploadComponent extends FileComponent$2 {
    ...
    attach(element) {
        ...
        console.log('🔴 [MultiImageUpload] attach() super.attach() complete, creating React container', {
            timestamp: new Date().toISOString(),
        });
    ...
    async loadReactComponent() {
        ...
        console.log('🔴 [MultiImageUpload] loadReactComponent() checking DOM state', {
            ...
            containerParentTagName: this.reactContainer.parentNode
                ? this.reactContainer.parentNode.tagName
                : null,
        ...
        try {
            if (!MultiImageUploadComponent.reactComponentFactory) {
                console.error('🔴 [MultiImageUpload] loadReactComponent() ABORTED - factory not registered', {
                    timestamp: new Date().toISOString(),
                });
            ...
            if (this.reactContainer) {
                console.log('🔴 [MultiImageUpload] loadReactComponent() displaying error message in container', {
                    timestamp: new Date().toISOString(),
                });
...
function RecordingScreen(props) {
    ...
    return (u$2("div", { className: "uppy-Audio-container", children: [u$2("div", { className: "uppy-Audio-audioContainer", children: hasRecordedAudio ? (
                ...
                u$2("audio", { className: "uppy-Audio-player", controls: true, src: recordedAudio })) : (u$2("canvas", { ref: canvasEl, className: "uppy-Audio-canvas" })) }), u$2("div", { className: "uppy-Audio-footer", children: [u$2("div", { className: "uppy-Audio-audioSourceContainer", children: shouldShowAudioSourceDropdown ? AudioSourceSelect(props) : null }), u$2("div", { className: "uppy-Audio-buttonContainer", children: [shouldShowRecordButton && (u$2(RecordButton$2, { recording: recording, onStartRecording: onStartRecording, onStopRecording: onStopRecording, i18n: i18n })), hasRecordedAudio && u$2(SubmitButton$2, { onSubmit: onSubmit, i18n: i18n }), hasRecordedAudio && (u$2(DiscardButton$2, { onDiscard: onDiscardRecordedAudio, i18n: i18n }))] }), u$2("div", { className: "uppy-Audio-recordingLength", children: !hasRecordedAudio && (u$2(RecordingLength$1, { recordingLengthSeconds: recordingLengthSeconds })) })] })] }));
}
    ...
    render() {
        ...
        return (u$2("div", { className: "uppy uppy-Webcam-container", children: [u$2("div", { className: "uppy-Webcam-videoContainer", children: capturedSnapshot && !recording && !recordedVideo ? (u$2("div", { className: "uppy-Webcam-imageContainer", children: u$2("img", { src: capturedSnapshot, className: "uppy-Webcam-video", alt: "capturedSnapshot" }) })) : (u$2("video", { ref: (videoElement) => {
                            this.videoElement = videoElement;
                                ...
                                : null }), u$2("div", { className: "uppy-Webcam-buttonContainer", children: [shouldShowSnapshotButton && (u$2(SnapshotButton, { onSnapshot: onSnapshot, i18n: i18n })), shouldShowRecordButton && (u$2(RecordButton, { recording: recording, onStartRecording: onStartRecording, onStopRecording: onStopRecording, i18n: i18n })), (hasRecordedVideo || hasCapturedSnapshot) && (u$2(SubmitButton, { onSubmit: onSubmit, i18n: i18n })), (hasRecordedVideo || hasCapturedSnapshot) && (u$2(DiscardButton, { onDiscard: onDiscardRecordedMedia, i18n: i18n }))] }), u$2("div", { className: "uppy-Webcam-recordingLength", children: shouldShowRecordingLength && (u$2(RecordingLength, { recordingLengthSeconds: recordingLengthSeconds })) })] })] }));
    }
}
...
class Webcam extends UIPlugin {
    ...
    render() {
        ...
        if (!webcamState.cameraReady || !webcamState.hasCamera) {
            return (u$2(PermissionsScreen, { icon: CameraIcon, i18n: this.i18n, hasCamera: webcamState.hasCamera }));
        }
