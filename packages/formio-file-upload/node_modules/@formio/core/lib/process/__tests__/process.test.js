...
describe('Process Tests', function () {
    it('Should submit data within a nested form.', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const context = {
                ...
                processors: index_1.Processors,
                scope: { errors },
                config: {
                    server: true,
                },
            };
            (0, index_1.processSync)(context);
            submission.data = context.data;
            node_assert_1.default.equal(context.scope.errors.length, 0);
        });
    });
    it('Should allow data from a Conditionally shown nested form when another nested form is conditionally not shown.', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
                components: [
                    {
            ...
            (0, index_1.processSync)(context);
            submission.data = context.data;
            node_assert_1.default.equal(lodash_1.default.get(context.submission.data, 'form1.data.form.data.textField'), 'one 1');
            node_assert_1.default.equal(lodash_1.default.get(context.submission.data, 'form1.data.form.data.textField1'), 'two 2');
        });
    });
    it('should remove submission data not in a nested form definition', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
                _id: {},
                title: 'parent',
            ...
            (0, index_1.processSync)(context);
            (0, chai_1.expect)(context.data).to.deep.include({
                child: { _id: 'submission id', data: { input: 'test' } },
            });
            (0, chai_1.expect)(context.data.child.data).to.not.have.property('invalid');
        });
    });
    it('Should produce errors for a multivalue textfield with a required value', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (0, index_1.processSync)(context);
            node_assert_1.default.equal(context.scope.errors.length, 2);
            node_assert_1.default.equal(context.scope.errors[0].ruleName, 'array');
            node_assert_1.default.equal(context.scope.errors[1].ruleName, 'required');
        });
    });
    it('Sets a value based on advanced conditions', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
                components: [
                    {
            ...
            (0, index_1.processSync)(context);
            node_assert_1.default.equal(context.data.test, '1');
            node_assert_1.default.equal(context.data.changeme, 'Foo');
        });
    });
    it('Should process nested form data correctly', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const submission = {
                data: {
                    submit: true,
            ...
            (0, index_1.processSync)(context);
            (0, chai_1.expect)(context.data.child.data.output).to.equal(20);
        });
    });
    it('Should process nested data correctly.', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
                _id: {},
                title: 'parent',
            ...
            submission.data = context.data;
            node_assert_1.default.equal(context.scope.errors.length, 0);
            node_assert_1.default.equal(context.data.showA, true);
            node_assert_1.default.equal(context.data.showB, true);
            node_assert_1.default.equal(context.data.showC, true);
            node_assert_1.default.deepEqual(context.data.childA.data, {
                a: 'One',
                b: 'Two',
            });
            node_assert_1.default.deepEqual(context.data.childB.data, {
                c: 'Three',
                d: 'Four',
            });
            node_assert_1.default.deepEqual(context.data.childC.data, {
                e: 'Five',
                f: 'Six',
            });
        });
    });
    it('Should allow the submission to go through if the subform is conditionally hidden', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
                _id: {},
                title: 'parent',
            ...
            submission.data = context.data;
            node_assert_1.default.equal(context.scope.errors.length, 0);
            node_assert_1.default.equal(context.data.showA, false);
            node_assert_1.default.equal(context.data.showB, true);
            node_assert_1.default.equal(context.data.showC, true);
            (0, node_assert_1.default)(!context.data.hasOwnProperty('childA'), 'The childA form should not be present.');
            node_assert_1.default.deepEqual(context.data.childB.data, {
                c: 'Three',
                d: 'Four',
            });
    ...
    it('Should process data within a fieldset properly.', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const submission = {
                data: {
                    firstName: 'Joe',
            ...
            (0, index_1.processSync)(context);
            (0, chai_1.expect)(context.data.firstName).to.equal('Joe');
            (0, chai_1.expect)(context.data.lastName).to.equal('Smith');
        });
    });
    it('Requires a conditionally visible field', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
                components: [
                    {
            ...
            (0, index_1.processSync)(context);
            node_assert_1.default.equal(context.scope.errors.length, 1);
            node_assert_1.default.equal(context.scope.errors[0].errorKeyOrMessage, 'required');
            node_assert_1.default.equal(context.scope.errors[0].context.path, 'requiredField');
        });
    });
    it("Doesn't require a conditionally hidden field", function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
                components: [
                    {
    ...
    it('Allows a conditionally required field', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
                components: [
                    {
    ...
    it('Ignores conditionally hidden fields', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
                components: [
                    {
            ...
            (0, index_1.processSync)(context);
            node_assert_1.default.deepEqual(context.data, { selector: 'one' });
            node_assert_1.default.equal(context.scope.errors.length, 0);
        });
    });
    it('Requires a conditionally visible field in a panel', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
                components: [
                    {
    ...
    it("Doesn't require a conditionally hidden field in a panel", function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
                components: [
                    {
    ...
    it('Allows a conditionally required field in a panel', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
                components: [
                    {
    ...
    it('Should ignore conditionally hidden fields in a panel during validation', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
                components: [
                    {
    ...
    it('Should not include submission data for conditionally hidden fields', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
                display: 'form',
                components: [
            ...
            (0, index_1.processSync)(context);
            (0, chai_1.expect)(context.data).to.deep.equal({ textField: '' });
        });
    });
    it('Should not include submission data for logically hidden fields', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
                display: 'form',
                components: [
    ...
    it('Should allow conditionally hidden text fields within DataGrid and EditGrids', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
                display: 'form',
                components: [
    ...
    it('Should allow conditionally hidden components that depend on state outside of the contextual row data', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
                display: 'form',
                components: [
    ...
    it('Should allow conditionally hidden components that depend on state outside of the contextual row data with nested structures', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
                display: 'form',
                components: [
    ...
    it('Should allow conditionally hidden components that depend on state outside of the contextual row data, with co-located component keys in the row that are not targets of conditions', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
                display: 'form',
                components: [
    ...
    it('Should allow conditionally hidden components that depend on state outside of the contextual row data, with nested and co-located component keys in the row that are not targets of conditions', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
                display: 'form',
                components: [
    ...
    it('Should correctly provide conditionals path for wizard panels, which affects the accuracy of validation when nested forms are presented ', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
                components: [
                    {
            ...
            (0, index_1.processSync)(context);
            node_assert_1.default.equal(context.scope.errors.length, 0);
            (0, chai_1.expect)(context.scope.conditionals).to.deep.equal([
                { path: 'formA', conditionallyHidden: true },
                { path: 'formB', conditionallyHidden: false },
            ]);
        });
    });
    it('Should include submission data for logically visible fields', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
                display: 'form',
                components: [
    ...
    it('Should include submission data for intentionally hidden fields', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
                display: 'form',
                components: [
    ...
    it('Should not filter a simple datamap compoennt', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
                display: 'form',
                components: [
    ...
    it('Should allow the submission to go through without errors if there is no subform reference value', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
            ...
            submission.data = context.data;
            node_assert_1.default.equal(context.scope.errors.length, 0);
            node_assert_1.default.deepEqual(context.data.form, { _id: '66c455fc0f00757fd4b0e79b', data: {} });
        });
    });
    it('Should not hide other components data from submission when address component is filled out', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const { form, submission } = fixtures_1.addressComponentWithOtherCondComponents;
            const errors = [];
            const context = {
                form,
                submission,
            ...
            (0, index_1.processSync)(context);
            submission.data = context.data;
            (0, chai_1.expect)(context.submission.data.number).to.be.equal(1);
            (0, chai_1.expect)(context.submission.data.textField).to.be.equal('some text');
        });
    });
    it('Should not hide other components data from submission when address component is not filled out and manual mode enabled', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const { form, submission } = fixtures_1.addressComponentWithOtherCondComponents2;
            const errors = [];
            const context = {
                form,
                submission,
            ...
            (0, index_1.processSync)(context);
            submission.data = context.data;
            (0, chai_1.expect)(context.submission.data.number1).to.be.equal(1);
            (0, chai_1.expect)(context.submission.data.number2).to.be.equal(2);
        });
    });
    it('Should not return validation error for multiple textarea with json data type when first value is array', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
    ...
    it('Should not unset values for conditionally visible fields with different formats of condtion based on selectboxes value', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
            ...
            const submission = {
                data: (0, utils_1.fastCloneDeep)(data),
                _id: '66f68c17481ea2ffbf5bb310',
                state: 'submitted',
            };
            const errors = [];
            ...
            (0, index_1.processSync)(context);
            submission.data = context.data;
            context.scope.conditionals.forEach((v) => node_assert_1.default.equal(v.conditionallyHidden, false));
            node_assert_1.default.deepEqual(context.data, data);
        });
    });
    it('Should not return error for the form with conditionals based on the Day component', function () {
        ...
        (0, chai_1.expect)((_a = context.scope.conditionals) === null || _a === void 0 ? void 0 : _a[0].conditionallyHidden).to.equal(false);
        node_assert_1.default.equal(context.scope.errors.length, 0);
    });
    it('Should not unset value of the component inside fieldset inside wizard', function () {
        ...
        (0, index_1.processSync)(context);
        submission.data = context.data;
        node_assert_1.default.deepEqual(context.data, { textField: '', textAreaFieldSet: 'test' });
        context.scope.conditionals.forEach((cond) => {
            (0, chai_1.expect)(cond.conditionallyHidden).to.be.equal(true);
        });
    });
    it('Should not unset value of the conditionally visible component when condtiion is based on select resource with save as ref', function () {
        ...
        (0, index_1.processSync)(context);
        submission.data = context.data;
        node_assert_1.default.deepEqual(context.data.textFieldShowOnTest1, 'test');
        context.scope.conditionals.forEach((cond) => {
            node_assert_1.default.equal(cond.conditionallyHidden, cond.path !== 'textFieldShowOnTest1');
        });
    });
    it('Should not unset values of deeply nested form when some components in other forms have conditional components', function () {
        ...
        node_assert_1.default.deepEqual(context.data, data);
        context.scope.conditionals.forEach((cond) => {
            node_assert_1.default.equal(cond.conditionallyHidden, cond.path === 'pmta.data.contacts.data.applicantOrganization.data.address.data.postalCode');
        });
    });
    it("Should validate Nested Form's components if it should not be cleared and no data provided", function () {
        return __awaiter(this, void 0, void 0, function* () {
            const nestedForm = {
                key: 'form',
                type: 'form',
            ...
            const form = {
                ...
                components: [
                    nestedForm,
                    Object.assign(Object.assign({}, nestedForm), { key: 'form1' }),
                    {
                        type: 'button',
                        label: 'Submit',
                        key: 'submit',
            ...
            const scope = (0, index_1.processSync)(context);
            (0, chai_1.expect)(scope.errors).to.have.length(2);
        });
    });
    it("Should validate Nested Form's components if it should not be cleared and no data provided and the parent form has errors itself", function () {
        return __awaiter(this, void 0, void 0, function* () {
            const nestedForm = {
                key: 'form',
                type: 'form',
            ...
            const scope = (0, index_1.processSync)(context);
            (0, chai_1.expect)(scope.errors).to.have.length(3);
        });
    });
    it('Should not clear container components when they have child layout components', function () {
        ...
        node_assert_1.default.deepEqual(context.data, {
            checkbox: true,
    ...
    it('Should not return errors for empty multiple values for url and dateTime', function () {
        ...
        (0, index_1.processSync)(context);
        submission.data = context.data;
        node_assert_1.default.deepEqual(context.scope.errors.length, 0);
    });
    it('Should calculate value on server for calculations based on dataSource component', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
            ...
            yield (0, index_1.process)(context);
            submission.data = context.data;
            node_assert_1.default.deepEqual(context.data, submission.data);
        });
    });
    it('Should return required validation error when the simple conditional value is set as a sting instead of boolean', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
                key: 'form',
                type: 'form',
            ...
            const scope = (0, index_1.processSync)(context);
            (0, chai_1.expect)(scope.errors).to.have.length(1);
        });
    });
    describe('Required component validation in nested form in DataGrid/EditGrid', function () {
        ...
        describe('For DataGrid:', function () {
            ...
            it('Should validate required component when it is filled out', function () {
                return __awaiter(this, void 0, void 0, function* () {
                    const submission = {
                        data: {
                            dataGrid: [
                    ...
                    (0, chai_1.expect)(context.scope.errors).to.have.length(0);
                });
            });
            it('Should not clear a value when it uses simple conditionals to hide and dependent value uses calculated value.', function () {
                return __awaiter(this, void 0, void 0, function* () {
                    const components = [
                        {
                            label: 'Checkbox',
                    ...
                    (0, index_1.processSync)(context);
                    node_assert_1.default.equal(context.data.radio, 'yes');
                });
            });
            it('Should not validate required component when it is not filled out', function () {
                return __awaiter(this, void 0, void 0, function* () {
                    const submission = {
                        data: {
                            dataGrid: [
                    ...
                    (0, index_1.processSync)(context);
                    (0, chai_1.expect)(context.scope.errors).to.have.length(1);
                });
            });
        });
        it('Should skip child validation with conditional', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const { form, submission } = fixtures_1.skipValidForConditionallyHiddenComp;
                const context = {
                    form,
                    submission,
                    data: submission.data,
        ...
        it('Should skip child validation with hidden parent component', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const { form, submission } = fixtures_1.skipValidWithHiddenParentComp;
                const context = {
                    form,
                    submission,
                    data: submission.data,
        ...
        it('Should skip child validation with logic', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const { form, submission } = fixtures_1.skipValidForLogicallyHiddenComp;
                const context = {
                    form,
                    submission,
                    data: submission.data,
        ...
        it('Should validate when all child components are empty in required Data Grid', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const { form, submission } = fixtures_1.forDataGridRequired;
                const context = {
                    form,
                    submission,
                    data: submission.data,
        ...
        it('Should validate required an empty array for multiple select', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const form = {
                ...
                submission.data = context.data;
                node_assert_1.default.equal(context.scope.errors.length, 1);
                node_assert_1.default.equal(context.scope.errors[0].ruleName, 'required');
            });
        });
        describe('For EditGrid:', function () {
            ...
            it('should return empty array when no data is provided', function () {
                return __awaiter(this, void 0, void 0, function* () {
                    const submission = {
                        data: {
                            editGrid: [],
                    ...
                    (0, index_1.processSync)(context);
                    (0, chai_1.expect)(context.data).to.deep.equal({ editGrid: [] });
                });
            });
            it('Should validate required component when it is filled out', function () {
                return __awaiter(this, void 0, void 0, function* () {
    ...
    describe('clearOnHide', function () {
        it('Should not include submission data from conditionally hidden containers when clearOnHide ("Omit Data When Conditionally Hidden" is true', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const { form, submission } = fixtures_1.clearOnHideWithCustomCondition;
        ...
        it('Should not return fields from conditionally hidden containers, clearOnHide = false', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const { form, submission } = fixtures_1.clearOnHideWithCustomCondition;
                const clonedSubmission = JSON.parse(JSON.stringify(submission));
                const containerComponent = (0, formUtil_1.getComponent)(form.components, 'section6');
        ...
        it('Should not validate fields from hidden containers, clearOnHide = false', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const { form, submission } = fixtures_1.clearOnHideWithHiddenParent;
                const context = {
                    form,
                    submission,
                    data: submission.data,
        ...
        it('Should include submission data from hidden containers even when clearOnHide ("Omit Data When Conditionally Hidden" is true', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const { form, submission } = fixtures_1.clearOnHideWithHiddenParent;
                const containerComponent = (0, formUtil_1.getComponent)(form.components, 'section6');
        ...
        it('Should include submission data for simple fields that are intentionally hidden, even when clearOnHide ("Omit When Conditionally Hidden") is true', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const components = [
                    {
                        label: 'Text Field',
                ...
                (0, index_1.processSync)(context);
                (0, chai_1.expect)(context.data).to.deep.equal({ textField: 'test' });
            });
        });
        it('Should include submission data for simple components that are intentionally hidden when clearOnHide ("Omit When Conditionally Hidden") is false', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const components = [
                    {
                        label: 'Text Field',
        ...
        it('Should include submission data for container components that are intentionally hidden, even when clearOnHide ("Omit When Conditionally Hidden") is true', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const components = [
                    {
                        key: 'container',
                ...
                (0, index_1.processSync)(context);
                (0, chai_1.expect)(context.data).to.deep.equal({ container: { textField: 'test' } });
            });
        });
        it('Should include submission data for container components that are intentionally hidden when clearOnHide ("Omit When Conditionally Hidden") is false', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const components = [
                    {
                        key: 'container',
        ...
        it("Should not include submission data for simple fields that are conditionally hidden when clearOnHide ('Omit When Conditionally Hidden') is true", function () {
            return __awaiter(this, void 0, void 0, function* () {
                const components = [
                    {
                        type: 'checkbox',
                ...
                (0, index_1.processSync)(context);
                (0, chai_1.expect)(context.data).to.deep.equal({ selector: false });
            });
        });
        it("Should include submission data for simple fields that are conditionally hidden when clearOnHide ('Omit When Conditionally Hidden') is false", function () {
            return __awaiter(this, void 0, void 0, function* () {
                const components = [
                    {
                        type: 'checkbox',
                ...
                (0, index_1.processSync)(context);
                (0, chai_1.expect)(context.data).to.deep.equal({ selector: false, textField: 'test' });
            });
        });
        it("Should not include submission data for container components that are conditionally hidden when clearOnHide ('Omit When Conditionally Hidden') is true", function () {
            return __awaiter(this, void 0, void 0, function* () {
                const components = [
                    {
                        type: 'checkbox',
        ...
        it("Should include submission data for container components that are conditionally hidden when clearOnHide ('Omit When Conditionally Hidden') is false (but not their children, assuming clearOnHide is true or omitted in the child)", function () {
            return __awaiter(this, void 0, void 0, function* () {
                const components = [
                    {
                        type: 'checkbox',
                ...
                (0, index_1.processSync)(context);
                (0, chai_1.expect)(context.data).to.deep.equal({ selector: false, container: {} });
            });
        });
        it("Should include submission data for container components that are conditionally hidden when clearOnHide ('Omit When Conditionally Hidden') is false (and include their children when clearOnHide is false in the child)", function () {
            return __awaiter(this, void 0, void 0, function* () {
                const components = [
                    {
                        type: 'checkbox',
                ...
                (0, index_1.processSync)(context);
                (0, chai_1.expect)(context.data).to.deep.equal({ selector: false, container: { textField: 'test' } });
            });
        });
        it("Should save 'level' field when custom error message is defined to correctly add error classes into app template ", function () {
            return __awaiter(this, void 0, void 0, function* () {
                const components = [
                    {
                        label: 'Text Field',
                ...
                (0, index_1.processSync)(context);
                (0, chai_1.expect)(context.scope.errors[0].level).to.equal('error');
            });
        });
        it('Should not show validation errors for required component inside conditionally hidden editGrid', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const components = fixtures_1.requiredFieldInsideEditGrid;
                const submission = {
                    data: {
                        selectGrids: '',
                        submit: true,
        ...
        it('Should not add undefined values for components.', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const form = {
                    components: [
                        {
                ...
                (0, index_1.processSync)(context);
                (0, node_assert_1.default)(!context.data.hasOwnProperty('fname'));
                (0, node_assert_1.default)(!context.data.hasOwnProperty('lname'));
            });
        });
    });
});
