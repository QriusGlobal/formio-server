...
describe('validateMaximumLength', function () {
    it('Validating a component without a maxLength property will return null', function () {
    ...
    it('Validating a component with a maxLength property and a length greater than maxLength will return a FieldError', function () {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    it('Validating a component with a maxLength property and a length less than maxLength will return null', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const component = Object.assign(Object.assign({}, components_1.simpleTextField), { validate: { maxLength: 4 } });
            const data = {
                component: 'foo',
    ...
    it('Validating a component with a maxLength property that is an empty string will return null', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const component = Object.assign(Object.assign({}, components_1.simpleTextField), { validate: { maxLength: 4 } });
            const data = {
                component: '',
