...
describe('validateMinimumSelectedCount', function () {
    it('Validting a non-select boxes component will return null', function () {
    ...
    it('Validating a select boxes component without minSelectedCount will return null', function () {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    it('Validating a select boxes component where the number of selected fields is less than minSelectedCount will return a FieldError', function () {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    it('Validating a select boxes component where the number of selected fields is equal to minSelectedCount will return null', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const component = Object.assign(Object.assign({}, components_1.simpleSelectBoxes), { validate: { minSelectedCount: 2 } });
            const data = {
                component: {
    ...
    it('Validating a select boxes component where the number of selected fields is greater than minSelectedCount will return null', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const component = Object.assign(Object.assign({}, components_1.simpleSelectBoxes), { validate: { minSelectedCount: 2 } });
            const data = {
                component: {
