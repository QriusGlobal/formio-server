...
describe('validateJson', function () {
    it('A simple component without JSON logic validation will return null', function () {
    ...
    it('A simple component with JSON logic evaluation will return a FieldError if the JSON logic returns invalid', function () {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    it('A simple component with JSON logic evaluation will return null if the JSON logic returns valid', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const component = Object.assign(Object.assign({}, components_1.simpleTextField), { validate: {
                    json: {
                        if: [
    ...
    it('A simple component with JSON logic evaluation will validate even if the value is falsy', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const component = Object.assign(Object.assign({}, components_1.simpleTextField), { validate: {
                    json: {
                        if: [
    ...
    it('Should have access to form JSON in its validation context', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const component = Object.assign(Object.assign({}, components_1.simpleTextField), { validate: {
                    json: {
                        if: [
