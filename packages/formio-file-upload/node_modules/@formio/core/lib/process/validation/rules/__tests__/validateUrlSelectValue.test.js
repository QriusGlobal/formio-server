...
describe('validateUrlSelectValue', function () {
    it('Validating a component without the remote value validation parameter will return null', function () {
    ...
    it('Validating a select component without the remote value validation parameter will return null', function () {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    it('The remote value validation will generate the correct URL given a searchField and a valueProperty', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const component = Object.assign(Object.assign({}, components_1.simpleSelectOptions), { dataSrc: 'url', data: {
                    url: 'http://localhost:8080/numbers',
                    headers: [],
    ...
    it('Validating a select component with the remote validation parameter will return a FieldError if the value does not exist and the API returns an array', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const component = Object.assign(Object.assign({}, components_1.simpleSelectOptions), { dataSrc: 'url', data: {
                    url: 'http://localhost:8080/numbers',
                    headers: [],
    ...
    it('Validating a select component with the remote validation parameter will return a FieldError if the value does not exist and the API returns an object', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const component = Object.assign(Object.assign({}, components_1.simpleSelectOptions), { dataSrc: 'url', data: {
                    url: 'http://localhost:8080/numbers',
                    headers: [],
    ...
    it('Validating a select component with the remote validation parameter will return null if the value exists', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const component = Object.assign(Object.assign({}, components_1.simpleSelectOptions), { dataSrc: 'url', data: {
                    url: 'http://localhost:8080/numbers',
                    headers: [],
