...
describe('validateMinimumLength', function () {
    it('Validating a component without a minLength property will return null', function () {
    ...
    it('Validating a component with a minLength property and a length less than minLength will return a FieldError', function () {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    it('Validating a component with a minLength property and a length equal to minLength will return null', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const component = Object.assign(Object.assign({}, components_1.simpleTextField), { validate: { minLength: 4 } });
            const data = {
                component: 'fooo',
    ...
    it('Validating a component with a minLength property and a length greater than minLength will return null', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const component = Object.assign(Object.assign({}, components_1.simpleTextField), { validate: { minLength: 4 } });
            const data = {
                component: 'Hello, world!',
