...
describe('validateMaximumValue', function () {
    it('Validating a component without the max property will return null', function () {
    ...
    it('Validating a number component without the max property will return null', function () {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    it('Validating a number component that contains the max property will return null if the value is less than the maximum', function () {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    it('Validating a number component that contains the max property will return a FieldError if the value is greater than the maximum', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const component = Object.assign(Object.assign({}, components_1.simpleNumberField), { validate: { max: 50 } });
            const data = {
                component: 55,
    ...
    it('Validating a number component that contains the max property will return null if the value is equal to the maximum', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const component = Object.assign(Object.assign({}, components_1.simpleNumberField), { validate: { max: 50 } });
            const data = {
                component: 50,
