...
describe('validateMinimumWords', function () {
    ...
    it('Validating a component with the minWords property will return a FieldError if the number of words is less than the minimum', function () {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    it('Validating a component with the minWords property will return null if the number of words is equal to the minimum', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const component = Object.assign(Object.assign({}, components_1.simpleTextField), { validate: { minWords: 3 } });
            const data = {
    ...
    it('Validating a component with the minWords property will return null if the number of words is greater than the minimum', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const component = Object.assign(Object.assign({}, components_1.simpleTextField), { validate: { minWords: 3 } });
            const data = {
