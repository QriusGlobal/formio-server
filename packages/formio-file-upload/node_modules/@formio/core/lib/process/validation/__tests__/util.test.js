...
describe('interpolateErrors', function () {
    it('Interpolated validation errors should include the rule name mapping in the "validator" param for simple components', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const component of forms_1.simpleForm.components) {
                ...
                yield (0, __1.validateProcess)({
                    ...
                    row: data,
                    path,
                    value: (0, lodash_1.get)(data, component.key),
    ...
    it('Interpolated validation errors should include the rule name mapping in the "validator" param for nested components', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const data = {
                dataGrid: [
                    {
            ...
            const result = new Map();
            yield (0, formUtil_1.eachComponentDataAsync)(forms_1.simpleNestedForm.components, data, (component, data, row, path) => __awaiter(this, void 0, void 0, function* () {
                const scope = { errors: [] };
                yield (0, __1.validateProcess)({
                    component,
                    scope,
    ...
    it('Interpolated validation errors should include the rule name mapping in the "validator" param for components with custom validation', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const data = {
            ...
            const result = new Map();
            for (const component of forms_1.simpleCustomValidationForm.components) {
                const path = component.key;
                const scope = { errors: [] };
                yield (0, __1.validateProcess)({
                    component,
    ...
    it('Interpolated validation errors should include the rule name mapping in the "validator" param for components with json logic validation', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const data = {
                jsonLogic: 'abc',
                submit: false,
            ...
            const result = new Map();
            for (const component of forms_1.simpleJsonLogicValidationForm.components) {
                const path = component.key;
                const scope = { errors: [] };
                yield (0, __1.validateProcess)({
                    component,
