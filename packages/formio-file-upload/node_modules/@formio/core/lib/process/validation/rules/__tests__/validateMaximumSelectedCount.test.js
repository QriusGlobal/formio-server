...
describe('validateMaximumSelectedCount', function () {
    ...
    it('Validating a select boxes component without maxSelectedCount will return null', function () {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    it('Validating a select boxes component where the number of selected fields is greater than maxSelectedCount will return a FieldError', function () {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    it('Validating a select boxes component where the number of selected fields is equal to maxSelectedCount will return null', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const component = Object.assign(Object.assign({}, components_1.simpleSelectBoxes), { validate: { maxSelectedCount: 1 } });
            const data = {
                component: {
    ...
    it('Validating a select boxes component where the number of selected fields is less than maxSelectedCount will return null', function () {
        return __awaiter(this, void 0, void 0, function* () {
