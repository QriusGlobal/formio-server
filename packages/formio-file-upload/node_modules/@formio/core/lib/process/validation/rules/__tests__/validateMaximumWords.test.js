...
describe('validateMaximumWords', function () {
    it('Validating a component without the maxWords property will return null', function () {
    ...
    it('Validating a component with the maxWords property will return a FieldError if the number of words is greater than the maximum', function () {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    it('Validating a component with the maxWords property will return null if the number of words is equal to the maximum', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const component = Object.assign(Object.assign({}, components_1.simpleTextField), { validate: { maxWords: 3 } });
            const data = {
    ...
    it('Validating a component with the maxWords property will return null if the number of words is less than the maximum', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const component = Object.assign(Object.assign({}, components_1.simpleTextField), { validate: { maxWords: 3 } });
            const data = {
                component: 'Hello, world!',
