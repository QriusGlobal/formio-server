...
describe('validateRegexPattern', function () {
    it('Validating a component without a pattern parameter will return null', function () {
    ...
    it('Validating a component with a pattern parameter will return a FieldError if the value does not match the pattern', function () {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    it('Validating a component with a pattern parameter will return null if the value matches the pattern', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const component = Object.assign(Object.assign({}, components_1.simpleTextField), { validate: { pattern: '\\d*' } });
            const data = {
                component: '12345',
    ...
    it('Validating a component with an empty value will not trigger the pattern validation', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const component = Object.assign(Object.assign({}, components_1.simpleTextField), { validate: { pattern: '\\d' } });
            const data = {
                component: '',
    ...
    it('Validating a component with a pattern parameter and a pattern message will return a FieldError if the value does not match the pattern', function () {
        return __awaiter(this, void 0, void 0, function* () {
