...
describe('validateTime', function () {
    it('Should validate a time component with a valid time value', function () {
    ...
    it('Should return a FieldError when validating a time component with an invalid time value', function () {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    it('Should return a FieldError when validating a time component with a valid format but one that does not match the dataFormat', function () {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    it('Should return a FieldError when validating a time component with an invalid format', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const data = { time: '12:' };
            const context = (0, util_1.generateProcessorContext)(timeField, data);
            const result = yield (0, validateTime_1.validateTime)(context);
