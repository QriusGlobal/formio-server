...
describe('validateCustom', function () {
    it('A simple custom validation will correctly be interpolated', function () {
    ...
    it('A custom validation that includes data will correctly be interpolated', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const component = Object.assign(Object.assign({}, components_1.simpleTextField), { validate: {
    ...
    it('A custom validation of empty component data will still validate', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const component = Object.assign(Object.assign({}, components_1.simpleTextField), { validate: {
                    custom: 'valid = data.simpleComponent === "any thing" ? true : "Invalid entry"',
                } });
