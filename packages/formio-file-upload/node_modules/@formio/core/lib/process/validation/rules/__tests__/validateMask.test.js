...
describe('validateMask', function () {
    it('Validating a mask component should return a FieldError if the value does not match the mask', function () {
    ...
    it('Validating a mask component should return null if the value matches the mask', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const component = Object.assign(Object.assign({}, components_1.simpleTextField), { inputMask: '999-999-9999' });
            const data = {
    ...
    it('Validating a multi-mask component should return a FieldError if the value does not match the masks', function () {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    it('Validating a mutil-mask component should return null if the value matches the masks', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const component = Object.assign(Object.assign({}, components_1.simpleTextField), { allowMultipleMasks: true, inputMasks: [
                    {
                        label: 'maskOne',
    ...
    it('Validating a mask component should return null if the instance contains a skipMaskValidation property', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const component = Object.assign(Object.assign({}, components_1.simpleTextField), { inputMask: '999-999-9999' });
            const data = {
                component: '1234',
            ...
            (0, chai_1.expect)(result).to.be.instanceOf(error_1.FieldError);
            (0, chai_1.expect)(result === null || result === void 0 ? void 0 : result.errorKeyOrMessage).to.equal('mask');
            context.instance = { skipMaskValidation: true };
            result = yield (0, validateMask_1.validateMask)(context);
            (0, chai_1.expect)(result).to.equal(null);
        });
    });
    it('Validating a mask component should return null if the validate object contains a skipMaskValidation', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const component = Object.assign(Object.assign({}, components_1.simpleTextField), { inputMask: '999-999-9999', validate: {
