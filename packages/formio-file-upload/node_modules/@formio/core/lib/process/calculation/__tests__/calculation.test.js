...
describe('Calculation processor', function () {
    it('Calculation processor will perform a simple calculation', function () {
    ...
    it('Calculation processor will perform a simple calculation that overwrites the value prop', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
                components: [
                    {
    ...
    it('Should not add calculated editGrid row vlaue to the blank submission ', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const form = {
                components: [
                    {
