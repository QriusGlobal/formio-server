 ...
 * @return {string}
 */
export declare function formatDate(value: ConfigType, format: string, timezone?: string): string;
...
export declare const getDateValidationFormat: (component: DayComponent) => "DD-MM-YYYY" | "MM-DD-YYYY";
export declare const isPartialDay: (component: DayComponent, value: string | undefined) => boolean;
export { dayjs };
