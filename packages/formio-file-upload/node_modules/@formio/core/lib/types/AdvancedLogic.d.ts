...
export type LogicTrigger = LogicTriggerSimple | LogicTriggerJavascript | LogicTriggerJson | LogicTriggerEvent;
...
export type LogicAction = LogicActionProperty | LogicActionValue | LogicActionMergeComponentSchema | LogicActionCustomAction;
