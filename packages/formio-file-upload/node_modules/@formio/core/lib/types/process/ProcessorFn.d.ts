...
export type ProcessorPostFn<ProcessorScope> = (context: ProcessorContext<ProcessorScope>) => Promise<void>;
export type ProcessorPostFnSync<ProcessorScope> = (context: ProcessorContext<ProcessorScope>) => void;
