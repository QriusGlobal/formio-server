...
export declare const processes: {
    ...
    conditions: ProcessorInfo<import("./conditions").ConditionsContext, void>;
    defaultValue: ProcessorInfo<import("./defaultValue").DefaultValueContext, void>;
    fetch: ProcessorInfo<import("./fetch").FetchContext, void>;
    filter: ProcessorInfo<import("./filter").FilterContext, void>;
    logic: {
        name: string;
        process: import("./ProcessorFn").ProcessorFn<import("./logic").LogicScope>;
        processSync: import("./ProcessorFn").ProcessorFnSync<import("./logic").LogicScope>;
