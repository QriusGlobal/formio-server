...
export type FieldSetComponent = NestedComponent & {
    components: Component[];
};
...
export type PhoneNumberComponent = NumberComponent & {
    inputMode: 'decimal';
};
...
export type SelectComponent = (JsonValuesSelectData | StaticValuesSelectData | CustomValuesSelectData | ResourceValueSelectData | UrlValuesSelectData) & SelectComponentOptions;
