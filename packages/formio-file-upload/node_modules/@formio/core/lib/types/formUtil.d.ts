...
export type EachComponentDataAsyncCallback = (component: Component, data: DataObject, row: any, path: string, components?: Component[], index?: number, parent?: Component | null, paths?: ComponentPaths) => Promise<boolean | void>;
export type EachComponentDataCallback = (component: Component, data: DataObject, row: any, path: string, components?: Component[], index?: number, parent?: Component | null, paths?: ComponentPaths) => boolean | void;
export type EachComponentCallback = (component: Component, path: string, components?: Component[], parent?: Component, paths?: ComponentPaths) => boolean | void;
export type EachComponentAsyncCallback = (component: Component, path: string, components?: Component[], parent?: Component, paths?: ComponentPaths) => Promise<boolean | void>;
