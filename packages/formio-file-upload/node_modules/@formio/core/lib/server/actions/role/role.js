    ...
    executor(scope) {
        return __awaiter(this, void 0, void 0, function* () {
            return (req, res, next) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (scope.action.settings.association !== 'existing' &&
                    scope.action.settings.association !== 'new') {
                ...
                if (!scope.action.settings.type ||
                    (scope.action.settings.type !== 'add' && scope.action.settings.type !== 'remove')) {
                ...
                if (scope.action.settings.association === 'new' &&
                    res.hasOwnProperty('resource') &&
                    !res.resource.item &&
                    scope.action.settings.role) {
                ...
                if (scope.action.settings.association === 'existing' && !scope.action.settings.role) {
                    ...
                    return res
                        .status(400)
                        .send('Missing role for RoleAction association of "existing". Must specify role to assign in action settings or a form component named "role"');
                }
                if (scope.action.settings.association === 'existing' && !res.resource.item) {
                    ...
                    return res
                        .status(400)
                        .send('Missing submission for RoleAction association of "existing:. Form must have a resource field named "submission".');
                }
