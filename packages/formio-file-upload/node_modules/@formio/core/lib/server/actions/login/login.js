...
const LoginAction = {
    ...
    checkAttempts(scope, error, user) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!(0, lodash_1.has)(user, 'metadata.login')) {
                (0, lodash_1.set)(user, 'metadata.login', {});
            }
    ...
    executor(scope) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (req, res, next) => __awaiter(this, void 0, void 0, function* () {
                var _a, _b;
                debug('Login Action');
                const username = (0, lodash_1.get)((_a = req.body) === null || _a === void 0 ? void 0 : _a.data, userfield);
                const password = (0, lodash_1.get)((_b = req.body) === null || _b === void 0 ? void 0 : _b.data, passfield);
                if (!username) {
                ...
                const hash = (0, lodash_1.get)(user.data, passfield);
                if (!hash || !hash.hash) {
                ...
                bcrypt.compare(password, hash.hash, (err, value) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    (0, lodash_1.unset)(user.data, passfield);
                    // Set the user object.
                    req.user = user;
