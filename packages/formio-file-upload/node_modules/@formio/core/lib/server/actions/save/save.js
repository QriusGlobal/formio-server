...
const SaveAction = {
    ...
    saveToForm(scope, resource) {
        let saveTo;
        (0, lodash_1.each)(scope.template.resources, (form) => {
        ...
        if (!saveTo) {
            (0, lodash_1.each)(scope.template.forms, (form) => {
                if (form.key === resource) {
                    saveTo = form;
                    return false;
                }
    ...
    childSubmission(scope, req, res, submission) {
        ...
        if (action.settings.mapping) {
            ...
            (0, lodash_1.each)(action.settings.fields, function (field, key) {
                if (field === 'data') {
                    (0, lodash_1.set)(childSub.data, key, submission.data);
                }
                else if ((0, lodash_1.has)(submission.data, field)) {
                    (0, lodash_1.set)(childSub.data, key, (0, lodash_1.get)(submission.data, field));
                }
            });
        }
    ...
    childResponse(scope, req, res) {
        ...
        if ((_a = res.resource) === null || _a === void 0 ? void 0 : _a.item) {
            ...
            if ((_b = action.settings) === null || _b === void 0 ? void 0 : _b.property) {
                (0, lodash_1.set)(req.body.data, action.settings.property, res.resource.item);
            }
