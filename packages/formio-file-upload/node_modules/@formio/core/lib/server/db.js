    ...
    save(collectionName, item) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                result = yield collection.findOneAndUpdate({ _id: this.ObjectId(item._id) }, { $set: (0, lodash_1.omit)(item, '_id') }, { upsert: true, returnOriginal: false });
            }
            catch (err) {
                error(err.message);
            }
        ...
        return __awaiter(this, arguments, void 0, function* (scope, id, update, allowFields = []) {
            ...
            try {
                ...
                const result = yield collection.updateOne(this.query(scope, { _id: id }), {
                    $set: (0, lodash_1.pick)(update, ['data', 'metadata', 'modified'].concat(allowFields)),
                });
