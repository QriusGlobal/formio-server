...
export default class WebformBuilder extends Component {
    ...
    addExistingResourceFields(resources) {
        _.each(resources, (resource, index) => {
            ...
            eachComponent(resource.components, (component) => {
                ...
                subgroup.components[`component-${component.key}`] = _.merge(fastCloneDeep(Components.components[component.type]
    ...
    attach(element) {
        ...
        return super.attach(element).then(() => {
            ...
            this.addEventListener(this.refs['sidebar-search'], 'input', _.debounce((e) => {
