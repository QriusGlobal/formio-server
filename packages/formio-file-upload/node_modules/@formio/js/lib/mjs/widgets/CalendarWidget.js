...
export default class CalendarWidget extends InputWidget {
    ...
    attach(input) {
        ...
        return superAttach
            .then(() => {
            if (this.component.shortcutButtons?.length) {
                return Formio.requireLibrary('shortcut-buttons-flatpickr', 'ShortcutButtonsPlugin', `${Formio.cdn['shortcut-buttons-flatpickr']}/shortcut-buttons-flatpickr.min.js`, true);
            }
        })
